...
<script>
	function print_invoice() {
		...
		window.location = 'find_all_invoice_due.php'; // hna hwdeh l sf7a tnya bs b3tlha el orser id
	}
	function print_invoice2() {

		window.location = 'find_all_invoice_upcoming.php'; // hna hwdeh l sf7a tnya bs b3tlha el orser id
	}

	function print_invoice3() {

		window.location = 'find_all_invoice_over_due.php'; // hna hwdeh l sf7a tnya bs b3tlha el orser id
	}
	
		function print_invoice4() {

		window.location = 'find_all_invoice_over_due_and_upcoming.php'; // hna hwdeh l sf7a tnya bs b3tlha el orser id
	}
</script>
