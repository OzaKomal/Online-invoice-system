...
function invoices_insert(){
	...
	sql('insert into `invoices` set       `code`=' . (($data['code'] !== '' && $data['code'] !== NULL) ? "'{$data['code']}'" : 'NULL') . ', `status`=' . (($data['status'] !== '' && $data['status'] !== NULL) ? "'{$data['status']}'" : 'NULL') . ', `date_due`=' . (($data['date_due'] !== '' && $data['date_due'] !== NULL) ? "'{$data['date_due']}'" : 'NULL') . ', `client`=' . (($data['client'] !== '' && $data['client'] !== NULL) ? "'{$data['client']}'" : 'NULL') . ', `client_contact`=' . (($data['client_contact'] !== '' && $data['client_contact'] !== NULL) ? "'{$data['client_contact']}'" : 'NULL') . ', `client_address`=' . (($data['client_address'] !== '' && $data['client_address'] !== NULL) ? "'{$data['client_address']}'" : 'NULL') . ', `client_phone`=' . (($data['client_phone'] !== '' && $data['client_phone'] !== NULL) ? "'{$data['client_phone']}'" : 'NULL') . ', `client_website`=' . (($data['client_website'] !== '' && $data['client_website'] !== NULL) ? "'{$data['client_website']}'" : 'NULL') . ', `client_comments`=' . (($data['client_comments'] !== '' && $data['client_comments'] !== NULL) ? "'{$data['client_comments']}'" : 'NULL') . ', `subtotal`=' . (($data['subtotal'] !== '' && $data['subtotal'] !== NULL) ? "'{$data['subtotal']}'" : 'NULL') . ', `discount`=' . (($data['discount'] !== '' && $data['discount'] !== NULL) ? "'{$data['discount']}'" : 'NULL') . ', `tax`=' . (($data['tax'] !== '' && $data['tax'] !== NULL) ? "'{$data['tax']}'" : 'NULL') . ', `total`=' . (($data['total'] !== '' && $data['total'] !== NULL) ? "'{$data['total']}'" : 'NULL') . ', `comments`=' . (($data['comments'] !== '' && $data['comments'] !== NULL) ? "'{$data['comments']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
	...
	// automatic client_email
	if($_REQUEST['filterer_client_email']){
		sql("update `invoices` set `client_email`='" . makeSafe($_REQUEST['filterer_client_email']) . "' where `id`='" . makeSafe($recID, false) . "'", $eo);
	}
	...
	sql("insert ignore into membership_userrecords set tableName='invoices', pkValue='" . makeSafe($recID, false) . "', memberID='" . makeSafe(getLoggedMemberID(), false) . "', dateAdded='" . time() . "', dateUpdated='" . time() . "', groupID='" . getLoggedGroupID() . "'", $eo);
...
function invoices_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `invoices` set       `code`=' . (($data['code'] !== '' && $data['code'] !== NULL) ? "'{$data['code']}'" : 'NULL') . ', `status`=' . (($data['status'] !== '' && $data['status'] !== NULL) ? "'{$data['status']}'" : 'NULL') . ', `date_due`=' . (($data['date_due'] !== '' && $data['date_due'] !== NULL) ? "'{$data['date_due']}'" : 'NULL') . ', `client`=' . (($data['client'] !== '' && $data['client'] !== NULL) ? "'{$data['client']}'" : 'NULL') . ', `client_contact`=' . (($data['client_contact'] !== '' && $data['client_contact'] !== NULL) ? "'{$data['client_contact']}'" : 'NULL') . ', `client_address`=' . (($data['client_address'] !== '' && $data['client_address'] !== NULL) ? "'{$data['client_address']}'" : 'NULL') . ', `client_phone`=' . (($data['client_phone'] !== '' && $data['client_phone'] !== NULL) ? "'{$data['client_phone']}'" : 'NULL') . ', `client_website`=' . (($data['client_website'] !== '' && $data['client_website'] !== NULL) ? "'{$data['client_website']}'" : 'NULL') . ', `client_comments`=' . (($data['client_comments'] !== '' && $data['client_comments'] !== NULL) ? "'{$data['client_comments']}'" : 'NULL') . ', `subtotal`=' . (($data['subtotal'] !== '' && $data['subtotal'] !== NULL) ? "'{$data['subtotal']}'" : 'NULL') . ', `discount`=' . (($data['discount'] !== '' && $data['discount'] !== NULL) ? "'{$data['discount']}'" : 'NULL') . ', `tax`=' . (($data['tax'] !== '' && $data['tax'] !== NULL) ? "'{$data['tax']}'" : 'NULL') . ', `total`=' . (($data['total'] !== '' && $data['total'] !== NULL) ? "'{$data['total']}'" : 'NULL') . ', `comments`=' . (($data['comments'] !== '' && $data['comments'] !== NULL) ? "'{$data['comments']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function invoices_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if(is_file(dirname(__FILE__).'/hooks/invoices.status.csv')){
		...
		$combo_status->ListItem = explode('||', entitiesToUTF8(convertLegacyOptions("Pending;;Due;;Over-due;;Paid;;Cancelled")));
		$combo_status->ListData = $combo_status->ListItem;
	}
	...
	if($selected_id){
		...
		$templateCode=str_replace('<%%VALUE(client)%%>', html_attr($row['client']), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(client)%%>', urlencode($urow['client']), $templateCode);
		$templateCode=str_replace('<%%VALUE(subtotal)%%>', html_attr($row['subtotal']), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(subtotal)%%>', urlencode($urow['subtotal']), $templateCode);
		$templateCode=str_replace('<%%VALUE(discount)%%>', html_attr($row['discount']), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(discount)%%>', urlencode($urow['discount']), $templateCode);
		$templateCode=str_replace('<%%VALUE(tax)%%>', html_attr($row['tax']), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(tax)%%>', urlencode($urow['tax']), $templateCode);
		$templateCode=str_replace('<%%VALUE(total)%%>', html_attr($row['total']), $templateCode);
		...
		$templateCode=str_replace('<%%URLVALUE(status)%%>', urlencode('Due'), $templateCode);
		...
		$templateCode=str_replace('<%%VALUE(tax)%%>', '0.1', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(tax)%%>', urlencode('0.1'), $templateCode);
	...
	if($dvprint){
		...
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "', type: 'GET', beforeSend: function(){ \$j('#client$rnd1').prop('disabled', true); \$j('#clientLoading').html('<img src=loading.gif align=top>'); }, complete: function(){".(($arrPerm[1] || (($arrPerm[3] == 1 && $ownerMemberID == getLoggedMemberID()) || ($arrPerm[3] == 2 && $ownerGroupID == getLoggedGroupID()) || $arrPerm[3] == 3)) ? "\$j('#client$rnd1').prop('disabled', false); " : "\$j('#client$rnd1').prop('disabled', true); ")."\$j('#clientLoading').html('');}\n";
	}
	$templateCode.="\t\t});\n";
	$templateCode.="\t};\n";
	...
	if( $_REQUEST['FilterField'][1]=='9' && $_REQUEST['FilterOperator'][1]=='<=>'){
		$templateCode.="\n<input type=hidden name=client_email value=\"" . html_attr((get_magic_quotes_gpc() ? stripslashes($_REQUEST['FilterValue'][1]) : $_REQUEST['FilterValue'][1]))."\">\n";
	}
